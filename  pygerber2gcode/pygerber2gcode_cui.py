...
def read_config(config_file):
	global INI_X, INI_Y, INI_Z, MOVE_HEIGHT, OUT_INCH_FLAG, IN_INCH_FLAG, XY_SPEED, Z_SPEED, LEFT_X, LOWER_Y, DRILL_SPEED, DRILL_Z_SPEED, DRILL_DEPTH, CUT_DEPTH, TOOL_D, DRILL_D, EDGE_TOOL_D, EDGE_DEPTH, EDGE_SPEED, EDGE_Z_SPEED, Z_STEP, GERBER_COLOR, DRILL_COLOR, EDGE_COLOR , CONTOUR_COLOR, GERBER_EXT, DRILL_EXT, EDGE_EXT, GCODE_EXT, GDRILL_EXT, GEDGE_EXT,MCODE_FLAG,DRILL_ENDMILL
	#global DRILL_UNIT, EDGE_UNIT, CAD_UNIT, CUT_FLAG, CUT_OV
